                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card-box">
                        ...
                        <div style="text-align: center">
                            <asp:RadioButton ID="rbCatalogo" runat="server" AutoPostBack="True" Text="Catalogo" GroupName="Personalizado" value="1" />

                            <asp:RadioButton ID="rbDiseñoPropio" runat="server" AutoPostBack="True" Text="Diseño Propio" GroupName="Personalizado" value="2" />
                        </div>
                    </div>
                </div>
                            ...
                            <asp:UpdatePanel ID="Calcular2" runat="server">
                                <ContentTemplate>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3">
                                            <asp:Label Text="Cantidad: " runat="server"> </asp:Label>
                                            <asp:TextBox runat="server" ID="txtCantidadP" CssClass="form-control autonumber"></asp:TextBox>
                                        </div>
                                        <div class="col-lg-3">
