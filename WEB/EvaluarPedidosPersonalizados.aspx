                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-6">
                                    ...
                                    <p style="color: #000000; font-style: normal; font-weight: bold">Cantidad: <asp:Label ID="lblcantidad" runat="server" Text="0"></asp:Label></p>
                                    ...
                                    <p style="color: #000000; font-style: normal; font-weight: bold"> Dias de elaboración:<asp:TextBox ID="txtNdias" CssClass="form-control" runat="server" TextMode="Number"></asp:TextBox> </p>
